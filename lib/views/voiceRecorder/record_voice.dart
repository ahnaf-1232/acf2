...
import 'package:acf2/services/http_provider.dart';
...
class _RecordVoiceState extends State<RecordVoice>
  ...
  Future<void> checkAndRequestPermission() async {
    ...
    if (status.isDenied || status.isPermanentlyDenied) {
      _showSnackBar("Microphone permission is required", AppColors.error);
    }
  }
  ...
  Future<void> _startRecording() async {
    try {
      if (await _audioRecorder.hasPermission()) {
        // Get a writable directory (app-specific storage)
        ...
        final String path = "${directory.path}/recording_$timestamp.wav";
      ...
      _showSnackBar("Failed to start recording: $e", AppColors.error);
    }
  }
